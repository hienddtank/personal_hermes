---
name: code-review
description: "Code review and pre-commit verification — security scans, quality gates, auto-fix loop, independent reviewer subagent, and general-purpose review checklists. Covers both pre-commit verification of YOUR changes and reviewing OTHER people's code."
version: 2.0.0
...
- **Pre-commit verification** — automated pipeline before your code lands (see below)
- **General code review** — manual review checklists and response formats (see [General Code Review Checklist](#general-code-review-checklist))
...
- When reviewing someone else's code or a PR for quality
...
Use this checklist when manually reviewing code changes, pull requests, or auditing existing code.
