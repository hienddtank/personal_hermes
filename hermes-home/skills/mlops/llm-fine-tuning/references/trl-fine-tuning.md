...
See **peft-fine-tuning** for LoRA, QLoRA, IA3, Prefix Tuning methods that work with TRL. PEFT handles parameter-efficient layer injection; TRL provides training loops and alignment algorithms.

### Unsloth Acceleration  
See **unsloth** for 2-5x faster LoRA/QLoRA fine-tuning with less VRAM. Produces identical results — use alongside peft/trl for speedup.
